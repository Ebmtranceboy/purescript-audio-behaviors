...
(function($PS) {
  ...
  var ReflectSymbols = function (reflectSymbols) {
      this.reflectSymbols = reflectSymbols;
  };                         
  var AudioGraphToObject = function (toObject) {
      this.toObject = toObject;
  };                         
  var AudioGraphProcessors = function (processors) {
      this.processors = processors;
  };
  var AudioGraphGenerators = function (generators) {
      this.generators = generators;
  };
  var AudioGraphAggregators = function (aggregators) {
      this.aggregators = aggregators;
  };
  var AsProcessorObject = function (asProcessorObject) {
      this.asProcessorObject = asProcessorObject;
  };
  var AsProcessor = function (asProcessor) {
      this.asProcessor = asProcessor;
  };
  var AsAggregatorObject = function (asAggregatorObject) {
      this.asAggregatorObject = asAggregatorObject;
  };
  ...
  var reflectSymbolsNil = new ReflectSymbols(function (v) {
      return Data_List_Types.Nil.value;
  });
  var reflectSymbols = function (dict) {
      return dict.reflectSymbols;
  };
  var reflectSymbolsCons = function (dictIsSymbol) {
      return function (dictReflectSymbols) {
          return new ReflectSymbols(function (v) {
              return new Data_List_Types.Cons(Data_Symbol.reflectSymbol(dictIsSymbol)(Data_Symbol.SProxy.value), reflectSymbols(dictReflectSymbols)(Record_Extra.SLProxy.value));
          });
      };
  };
  ...
  var graph = function (dictPos) {
      return function (dictAudioGraphToObject) {
          return function (g) {
              return new Graph(Data_Maybe.Nothing.value, toObject(dictAudioGraphToObject)(g));
          };
      };
  };             
  ...
  var g$primeadd = new GAdd(Data_Maybe.Nothing.value);
  ...
  var audioGraphProcessorsNil = new AudioGraphProcessors(function (v) {
      return function (g) {
          return Foreign_Object.empty;
      };
  });
  var audioGraphProcessorsGiveUp0 = function (dictIsSymbol) {
      return function (dictAudioGraphProcessors) {
          return new AudioGraphProcessors(function (v) {
              return function (g) {
                  return processors(dictAudioGraphProcessors)(Type_Data_RowList.RLProxy.value)(g);
              };
          });
      };
  }; 
  var audioGraphGeneratorsGiveUp0 = function (dictIsSymbol) {
      return function (dictAudioGraphGenerators) {
          return new AudioGraphGenerators(function (v) {
              return function (g) {
                  return generators(dictAudioGraphGenerators)(Type_Data_RowList.RLProxy.value)(g);
              };
          });
      };
  };
  var audioGraphGeneratorsCons = function (dictRowToList) {
      return new AudioGraphGenerators(function (v) {
          return function (g) {
              return Record_Unsafe.unsafeGet("generators")(g);
          };
      });
  };
  var audioGraphAggregatorsNil = new AudioGraphAggregators(function (v) {
      return function (g) {
          return Foreign_Object.empty;
      };
  });
  ...
  var asProcessorObject = function (dict) {
      return dict.asProcessorObject;
  };
  var audioGraphProcessorsCons = function (dictRowToList) {
      return function (dictAsProcessorObject) {
          return function (dictAudioGraphProcessors) {
              return new AudioGraphProcessors(function (v) {
                  return function (g) {
                      return Foreign_Object.union(asProcessorObject(dictAsProcessorObject)(Type_Data_RowList.RLProxy.value)(Record_Unsafe.unsafeGet("processors")(g)))(processors(dictAudioGraphProcessors)(Type_Data_RowList.RLProxy.value)(g));
                  };
              });
          };
      };
  };
  var asProcessorJust = function (dictIsSymbol) {
      return new AsProcessor(function (v) {
          return new Data_Maybe.Just(Data_Tuple.Tuple.create(v.value0)(Data_Symbol.reflectSymbol(dictIsSymbol)(v.value1)));
      });
  };
  var asProcessor = function (dict) {
      return dict.asProcessor;
  };
  var asProcessorObjectCons = function (dictIsSymbol) {
      return function (dictAsProcessorObject) {
          return function (dictAsProcessor) {
              return new AsProcessorObject(function (v) {
                  return function (g) {
                      var asStr = Data_Symbol.reflectSymbol(dictIsSymbol)(Data_Symbol.SProxy.value);
                      return Foreign_Object.union(Data_Maybe.maybe(Foreign_Object.empty)(Foreign_Object.singleton(asStr))(asProcessor(dictAsProcessor)(Record_Unsafe.unsafeGet(asStr)(g))))(asProcessorObject(dictAsProcessorObject)(Type_Data_RowList.RLProxy.value)(g));
                  };
              });
          };
      };
  }; 
  var asAggregatorObjectNil = new AsAggregatorObject(function (v) {
      return function (g) {
          return Foreign_Object.empty;
      };
  });
  var asAggregatorObject = function (dict) {
      return dict.asAggregatorObject;
  };
  var asAggregatorJust = function (dictReflectSymbols) {
      return new AsAggregator(function (v) {
          return new Data_Maybe.Just(new Data_Tuple.Tuple(v.value0, Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordString)(reflectSymbols(dictReflectSymbols)(v.value1))));
      });
  };
  var asAggregator = function (dict) {
      return dict.asAggregator;
  };
  var asAggregatorObjectCons = function (dictIsSymbol) {
      return function (dictAsAggregatorObject) {
          return function (dictAsAggregator) {
              return new AsAggregatorObject(function (v) {
                  return function (g) {
                      var asStr = Data_Symbol.reflectSymbol(dictIsSymbol)(Data_Symbol.SProxy.value);
                      return Foreign_Object.union(Data_Maybe.maybe(Foreign_Object.empty)(Foreign_Object.singleton(asStr))(asAggregator(dictAsAggregator)(Record_Unsafe.unsafeGet(asStr)(g))))(asAggregatorObject(dictAsAggregatorObject)(Type_Data_RowList.RLProxy.value)(g));
                  };
              });
          };
      };
  ...
  var audioWorkletGenerator = function (dictPos) {
      return function (handle) {
          return function (n) {
              return new AudioWorkletGenerator(Data_Maybe.Nothing.value, handle, Data_Functor.map(Foreign_Object.functorObject)(ap_)(n));
          };
      };
  };
  var g$primedelay = function (n) {
      return new GDelay(Data_Maybe.Nothing.value, ap_(n));
  };
  var g$primegain = function (n) {
      return new GGain(Data_Maybe.Nothing.value, ap_(n));
  };
  ...
  var audioGraphAggregatorsCons = function (dictRowToList) {
      return function (dictAsAggregatorObject) {
          return function (dictAudioGraphAggregators) {
              return new AudioGraphAggregators(function (v) {
                  return function (g) {
                      return Foreign_Object.union(asAggregatorObject(dictAsAggregatorObject)(Type_Data_RowList.RLProxy.value)(Record_Unsafe.unsafeGet("aggregators")(g)))(aggregators(dictAudioGraphAggregators)(Type_Data_RowList.RLProxy.value)(g));
                  };
              });
          };
      };
  };
  var audioGraphAggregatorsGiveUp0 = function (dictIsSymbol) {
      return function (dictAudioGraphAggregators) {
          return new AudioGraphAggregators(function (v) {
              return function (g) {
                  return aggregators(dictAudioGraphAggregators)(Type_Data_RowList.RLProxy.value)(g);
              };
          });
      };
  };
  var audioGraphToObject = function (dictValidAudioGraph) {
      return function (dictRowToList) {
          return function (dictAudioGraphGenerators) {
              return function (dictAudioGraphProcessors) {
                  return function (dictAudioGraphAggregators) {
                      return new AudioGraphToObject(function (g) {
                          return {
                              generators: generators(dictAudioGraphGenerators)(Type_Data_RowList.RLProxy.value)(g),
                              processors: processors(dictAudioGraphProcessors)(Type_Data_RowList.RLProxy.value)(g),
                              aggregators: aggregators(dictAudioGraphAggregators)(Type_Data_RowList.RLProxy.value)(g)
                          };
                      });
                  };
              };
  ...
  exports["audioWorkletGenerator"] = audioWorkletGenerator;
  exports["gain"] = gain;
  exports["speaker'"] = speaker$prime;
  exports["graph"] = graph;
  exports["g'gain"] = g$primegain;
  exports["g'delay"] = g$primedelay;
  exports["g'add"] = g$primeadd;
  exports["defaultExporter"] = defaultExporter;
  exports["runInBrowser"] = runInBrowser;
  exports["asProcessorJust"] = asProcessorJust;
  exports["asProcessorObjectCons"] = asProcessorObjectCons;
  exports["asProcessorObjectNil"] = asProcessorObjectNil;
  exports["audioGraphProcessorsNil"] = audioGraphProcessorsNil;
  exports["audioGraphProcessorsCons"] = audioGraphProcessorsCons;
  exports["audioGraphProcessorsGiveUp0"] = audioGraphProcessorsGiveUp0;
  exports["audioGraphGeneratorsCons"] = audioGraphGeneratorsCons;
  exports["audioGraphGeneratorsGiveUp0"] = audioGraphGeneratorsGiveUp0;
  exports["reflectSymbolsNil"] = reflectSymbolsNil;
  exports["reflectSymbolsCons"] = reflectSymbolsCons;
  exports["asAggregatorJust"] = asAggregatorJust;
  exports["asAggregatorObjectCons"] = asAggregatorObjectCons;
  exports["asAggregatorObjectNil"] = asAggregatorObjectNil;
  exports["audioGraphAggregatorsNil"] = audioGraphAggregatorsNil;
  exports["audioGraphAggregatorsCons"] = audioGraphAggregatorsCons;
  exports["audioGraphAggregatorsGiveUp0"] = audioGraphAggregatorsGiveUp0;
  exports["audioGraphToObject"] = audioGraphToObject;
  exports["soundscapeRunnableMedia"] = soundscapeRunnableMedia;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.Karplus"] = $PS["FRP.Behavior.Audio.Example.Karplus"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.Karplus"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_List_Types = $PS["Data.List.Types"];
  var Data_NonEmpty = $PS["Data.NonEmpty"];
  var Data_Symbol = $PS["Data.Symbol"];
  ...
  var $$Math = $PS["Math"];
  var Record_Extra = $PS["Record.Extra"];                
  var pluck = function (f) {
      return function (d) {
          return FRP_Behavior_Audio.graph(Data_Typelevel_Num_Sets.posD1)(FRP_Behavior_Audio.audioGraphToObject()()(FRP_Behavior_Audio.audioGraphGeneratorsGiveUp0(new Data_Symbol.IsSymbol(function () {
              return "aggregators";
          }))(FRP_Behavior_Audio.audioGraphGeneratorsCons()))(FRP_Behavior_Audio.audioGraphProcessorsGiveUp0(new Data_Symbol.IsSymbol(function () {
              return "aggregators";
          }))(FRP_Behavior_Audio.audioGraphProcessorsGiveUp0(new Data_Symbol.IsSymbol(function () {
              return "generators";
          }))(FRP_Behavior_Audio.audioGraphProcessorsCons()(FRP_Behavior_Audio.asProcessorObjectCons(new Data_Symbol.IsSymbol(function () {
              return "del";
          }))(FRP_Behavior_Audio.asProcessorObjectNil)(FRP_Behavior_Audio.asProcessorJust(new Data_Symbol.IsSymbol(function () {
              return "combine";
          }))))(FRP_Behavior_Audio.audioGraphProcessorsNil))))(FRP_Behavior_Audio.audioGraphAggregatorsCons()(FRP_Behavior_Audio.asAggregatorObjectCons(new Data_Symbol.IsSymbol(function () {
              return "combine";
          }))(FRP_Behavior_Audio.asAggregatorObjectCons(new Data_Symbol.IsSymbol(function () {
              return "gain";
          }))(FRP_Behavior_Audio.asAggregatorObjectCons(new Data_Symbol.IsSymbol(function () {
              return "out";
          }))(FRP_Behavior_Audio.asAggregatorObjectNil)(FRP_Behavior_Audio.asAggregatorJust(FRP_Behavior_Audio.reflectSymbolsCons(new Data_Symbol.IsSymbol(function () {
              return "combine";
          }))(FRP_Behavior_Audio.reflectSymbolsNil))))(FRP_Behavior_Audio.asAggregatorJust(FRP_Behavior_Audio.reflectSymbolsCons(new Data_Symbol.IsSymbol(function () {
              return "del";
          }))(FRP_Behavior_Audio.reflectSymbolsNil))))(FRP_Behavior_Audio.asAggregatorJust(FRP_Behavior_Audio.reflectSymbolsCons(new Data_Symbol.IsSymbol(function () {
              return "gain";
          }))(FRP_Behavior_Audio.reflectSymbolsCons(new Data_Symbol.IsSymbol(function () {
              return "mic";
          }))(FRP_Behavior_Audio.reflectSymbolsNil)))))(FRP_Behavior_Audio.audioGraphAggregatorsGiveUp0(new Data_Symbol.IsSymbol(function () {
              return "generators";
          }))(FRP_Behavior_Audio.audioGraphAggregatorsGiveUp0(new Data_Symbol.IsSymbol(function () {
              return "processors";
          }))(FRP_Behavior_Audio.audioGraphAggregatorsNil)))))({
              aggregators: {
                  out: new Data_Tuple.Tuple(FRP_Behavior_Audio["g'add"], Record_Extra.SLProxy.value),
                  combine: new Data_Tuple.Tuple(FRP_Behavior_Audio["g'add"], Record_Extra.SLProxy.value),
                  gain: new Data_Tuple.Tuple(FRP_Behavior_Audio["g'gain"](0.9), Record_Extra.SLProxy.value)
              },
              processors: {
                  del: new Data_Tuple.Tuple(FRP_Behavior_Audio["g'delay"](d), Data_Symbol.SProxy.value)
              },
              generators: {
                  mic: FRP_Behavior_Audio.audioWorkletGenerator(Data_Typelevel_Num_Sets.posD1)("klank-lf-burst")(Foreign_Object.union(Foreign_Object.singleton("nsamples")(25.0))(Foreign_Object.singleton("freq")(f)))
              }
          });
      };
  };
  var scene = function (time) {
      var rad = time * $$Math.pi;
      return Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(FRP_Behavior_Audio["speaker'"](Data_Typelevel_Num_Sets.posD1)(FRP_Behavior_Audio.gain(Data_Typelevel_Num_Sets.posD1)(0.5)(new Data_NonEmpty.NonEmpty(pluck(1.0)(4.0e-3), new Data_List_Types.Cons(pluck(1.2)(3.0e-3), new Data_List_Types.Cons(pluck(1.3333)(5.0e-3), new Data_List_Types.Cons(pluck(1.49)(6.0e-3), Data_List_Types.Nil.value)))))));
  };
  var main = function (ctx) {
      return FRP_Behavior_Audio.runInBrowser(FRP_Behavior_Audio.soundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD1))(scene)(Data_Unit.unit)(ctx)({
          msBetweenSamples: 20,
          msBetweenPings: 15,
...
PS["FRP.Behavior.Audio.Example.Karplus"].main();