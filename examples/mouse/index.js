...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.Mouse"] = $PS["FRP.Behavior.Audio.Example.Mouse"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.Mouse"];
  var Control_Apply = $PS["Control.Apply"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_HeytingAlgebra = $PS["Data.HeytingAlgebra"];
  ...
  var scene = function (mouse) {
      var poz = FRP_Behavior_Mouse.position(mouse);
      var f = function (cl) {
          return function (pozz) {
              return FRP_Behavior_Audio["speaker'"](Data_Typelevel_Num_Sets.posD1)(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)((function () {
                  if (cl) {
                      return 0.2;
                  };
                  return 0.0;
              })())(FRP_Behavior_Audio.sinOsc(Data_Maybe.maybe(0.1)(function (v) {
                  return Data_Int.toNumber(v.y) + 220.0;
              })(pozz))));
          };
      };
      var click = Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))((function () {
          var $5 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
          return function ($6) {
              return $5(Data_Set.isEmpty($6));
          };
      })())(FRP_Behavior_Mouse.buttons(mouse));
      return Data_Function["const"](Control_Apply.apply(FRP_Behavior.applyABehavior(FRP_Event.functorEvent))(Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(f)(click))(poz));
  };
  var main = {
      run: FRP_Behavior_Audio.runInBrowser_(FRP_Behavior_Audio.soundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD1))(function __do() {
...
PS["FRP.Behavior.Audio.Example.Mouse"].main();