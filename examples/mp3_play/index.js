...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.Mp3Play"] = $PS["FRP.Behavior.Audio.Example.Mp3Play"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.Mp3Play"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Function = $PS["Data.Function"];
  var Data_List_Types = $PS["Data.List.Types"];
  var Data_NonEmpty = $PS["Data.NonEmpty"];
  ...
  var FRP_Event = $PS["FRP.Event"];
  var Foreign_Object = $PS["Foreign.Object"];                
  var scene = Data_Function["const"](Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(FRP_Behavior_Audio.dup1(Data_Typelevel_Num_Sets.posD2)(Data_Semiring.add(FRP_Behavior_Audio.semiringAudioUnit)(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.1)(FRP_Behavior_Audio.sinOsc(349.0)))(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.1)(FRP_Behavior_Audio.sinOsc(220.0))))(function (mono) {
  ...
  var main = function (ctx) {
      return function __do() {
          ...
          return FRP_Behavior_Audio.runInBrowser(FRP_Behavior_Audio.soundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD2))(scene)(Data_Unit.unit)(ctx)({
              msBetweenSamples: 20,
              msBetweenPings: 15,
...
PS["FRP.Behavior.Audio.Example.Mp3Play"].main();