...
(function($PS) {
  ...
  var gainT = function (dictPos) {
      return function (n) {
          return Gain.create(Data_Maybe.Nothing.value)(n);
      };
  };                                                  
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.AudioParameters"] = $PS["FRP.Behavior.Audio.Example.AudioParameters"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.AudioParameters"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var FRP_Event = $PS["FRP.Event"];
  var Foreign_Object = $PS["Foreign.Object"];                
  var split = function (dictOrd) {
      return function (s) {
          return function (p) {
              return Data_Array.span(function ($7) {
                  return (function (v) {
                      return Data_Ord.greaterThanOrEq(dictOrd)(s)(v);
                  })(Data_Tuple.fst($7));
              })(p);
          };
      };
  };
  var pwf0 = Control_Bind.join(Control_Bind.bindArray)(Data_Functor.map(Data_Functor.functorArray)(function (i) {
      return Data_Functor.map(Data_Functor.functorArray)(function (v) {
          return new Data_Tuple.Tuple(v.value0 + 4.0 * Data_Int.toNumber(i), v.value1);
      })([ new Data_Tuple.Tuple(0.0, 0.0), new Data_Tuple.Tuple(5.0e-2, 0.7), new Data_Tuple.Tuple(0.15, 8.0e-2) ]);
  })(Data_Array.range(0)(400)));
  var kr = 20.0 / 1000.0;
  var gn = function (s) {
      return function (p) {
          var ht = split(Data_Ord.ordNumber)(s)(p);
          ...
          var $6 = Data_Tuple.fst(right) - s < kr;
          if ($6) {
              return {
  ...
  var scene = function (t) {
      return Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(FRP_Behavior_Audio["speaker'"](Data_Typelevel_Num_Sets.posD1)(FRP_Behavior_Audio.gainT(Data_Typelevel_Num_Sets.posD1)(gn(t)(pwf0))(new Data_NonEmpty.NonEmpty(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.1)(FRP_Behavior_Audio.sinOsc(450.0)), new Data_List_Types.Cons(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.5)(FRP_Behavior_Audio.sinOsc(220.0)), new Data_List_Types.Cons(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.25)(FRP_Behavior_Audio.sinOsc(690.0)), new Data_List_Types.Cons(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.1)(FRP_Behavior_Audio.sinOsc(910.0)), Data_List_Types.Nil.value)))))));
  };
...
PS["FRP.Behavior.Audio.Example.AudioParameters"].main();