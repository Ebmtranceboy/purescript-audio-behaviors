...
(function($PS) {
  ...
  var speaker = function (dictPos) {
      return Speaker.create(Data_Maybe.Nothing.value);
  };
  ...
  var runInBrowser_ = function (dictRunnableMedia) {
      return function (scene$prime) {
                      ...
                      return function (audioInfo) {
                          return function (visualInfo) {
                              return function (exporter) {
                                  return function __do() {
                                      var scene = scene$prime();
                                      return runInBrowser(dictRunnableMedia)(scene)(accumulator)(ctx)(engineInfo)(audioInfo)(visualInfo)(exporter)();
                                  };
                              };
                          };
                      };
  ...
  var gainT_$prime = function (dictPos) {
      return function (s) {
          return function (n) {
              var $5138 = Gain.create(new Data_Maybe.Just(s))(n);
              var $5139 = Data_NonEmpty.singleton(Data_List_Types.plusList);
  ...
  var playBufT_ = function (dictPos) {
      return function (s) {
          return function (handle) {
              return function (n) {
                  return new PlayBuf(new Data_Maybe.Just(s), handle, n, ap_(0.0));
              };
          };
      };
  };
  ...
  exports["playBufT_"] = playBufT_;
  exports["gainT_'"] = gainT_$prime;
  exports["defaultExporter"] = defaultExporter;
  exports["runInBrowser_"] = runInBrowser_;
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.Bach"] = $PS["FRP.Behavior.Audio.Example.Bach"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.Bach"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Parallel_Class = $PS["Control.Parallel.Class"];
  ...
  var ThreeDots = (function () {
      function ThreeDots(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ThreeDots.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ThreeDots(value0, value1, value2);
              };
          };
      };
      return ThreeDots;
  ...
  var Seq8 = (function () {
      function Seq8(value0, value1, value2, value3, value4) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      Seq8.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return function (value4) {
                          return new Seq8(value0, value1, value2, value3, value4);
                      };
                  };
              };
          };
  ...
  var PVD = (function () {
      function PVD(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      };
      PVD.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new PVD(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var Hocket2 = (function () {
      function Hocket2(value0, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      Hocket2.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return function (value4) {
                                          ...
                                          return function (value9) {
                                              return function (value10) {
                                                  return function (value11) {
                                                      return new Hocket2(value0, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11);
                                                  };
                                              };
                                          };
                                      };
  ...
  var Hocket1 = (function () {
      function Hocket1(value0, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      Hocket1.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return function (value4) {
                                              ...
                                              return function (value10) {
                                                  return function (value11) {
                                                      return function (value12) {
                                                          return new Hocket1(value0, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12);
                                                      };
                                                  };
                                              };
                                          };
  ...
  var Hocket0 = (function () {
      function Hocket0(value0, value1, value2, value3, value4) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      Hocket0.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return function (value4) {
                          return new Hocket0(value0, value1, value2, value3, value4);
                      };
                  };
              };
          };
  ...
  var EOP = (function () {
      function EOP(value0, value1, value2, value3, value4, value5) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      EOP.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return function (value4) {
                          return function (value5) {
                              return new EOP(value0, value1, value2, value3, value4, value5);
                          };
                      };
                  };
              };
  ...
  var twom = function (n) {
      return function (v) {
          return [ new PVD(v.value0, Data_Int.toNumber(n * 6 | 0), tempo * 5.5, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 4 | 0), tempo * 3.2, false) ];
      };
  };
  var stac = 3.8;
  var stdm = function (n) {
      return function (a) {
          return Data_Array.mapWithIndex(function (i) {
              return function (x) {
                  return new PVD(x, Data_Int.toNumber(i + (n * 6 | 0) | 0), tempo * stac, false);
              };
          })(a);
      };
  };
  var stdmM = function (i) {
      return function (s) {
          return stdm(i)([ s, s - 2 | 0, s - 4 | 0, s - 2 | 0, s, s - 4 | 0 ]);
      };
  };
  var stdmm = function (i) {
      return function (s) {
          return stdm(i)([ s, s - 1 | 0, s - 3 | 0, s - 1 | 0, s, s - 3 | 0 ]);
      };
  };
  var threeDots = function (n) {
      return function (v) {
          return [ new PVD(v.value0, Data_Int.toNumber(n * 6 | 0), tempo * 6.5, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 2 | 0), tempo * stac, true), new PVD(v.value2, Data_Int.toNumber((n * 6 | 0) + 4 | 0), tempo * stac, true) ];
      };
  };
  var split = function (s) {
      return function (p) {
          return Data_Array.span(function ($129) {
              return (function (v) {
                  return s >= v;
              })(Data_Tuple.fst($129));
          })(p);
  ...
  var seq8$prime = function (n) {
      return function (v) {
          return [ new PVD(v.value0, Data_Int.toNumber(n * 6 | 0), tempo * 4.5, true), new PVD(v.value1, Data_Int.toNumber(n * 6 | 0) + 1.9, tempo * 3.4, true), new PVD(v.value2, Data_Int.toNumber((n * 6 | 0) + 4 | 0), tempo * 6.5, true), new PVD(v.value3, Data_Int.toNumber((n * 6 | 0) + 8 | 0), tempo * 4.5, true), new PVD(v.value4, Data_Int.toNumber((n * 6 | 0) + 10 | 0), tempo * 4.5, true) ];
      };
  };
  var seq8 = function (n) {
      return function (v) {
          return [ new PVD(v.value0, Data_Int.toNumber(n * 6 | 0), tempo * 4.5, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 2 | 0), tempo * 4.5, true), new PVD(v.value2, Data_Int.toNumber((n * 6 | 0) + 4 | 0), tempo * 6.5, true), new PVD(v.value3, Data_Int.toNumber((n * 6 | 0) + 8 | 0), tempo * 4.5, true), new PVD(v.value4, Data_Int.toNumber((n * 6 | 0) + 10 | 0), tempo * 4.5, true) ];
      };
  };
  var pwf = function (s) {
      return function (dur) {
          return [ new Data_Tuple.Tuple(0.0, 1.0), new Data_Tuple.Tuple((s + dur) - 5.0e-2, 1.0), new Data_Tuple.Tuple((s + dur) - 2.0e-2, 0.0) ];
      };
  };
  var m61 = [ new PVD(31, Data_Int.toNumber(61 * 6 | 0), tempo * 4.5, true), new PVD(30, Data_Int.toNumber((61 * 6 | 0) + 2 | 0), tempo * 4.5, true), new PVD(28, Data_Int.toNumber((61 * 6 | 0) + 4 | 0), tempo * 4.5, true) ];
  var m30ToM31 = [ new PVD(47, Data_Int.toNumber(30 * 6 | 0), tempo * 4.5, true), new PVD(59, Data_Int.toNumber((30 * 6 | 0) + 4 | 0), tempo * 5.5, true), new PVD(57, Data_Int.toNumber((30 * 6 | 0) + 8 | 0), tempo * 4.5, true), new PVD(56, Data_Int.toNumber((30 * 6 | 0) + 10 | 0), tempo * 4.5, true) ];
  var kr = 20.0 / 1000.0;
  var hocket2 = function (n) {
      return function (v) {
          return [ new PVD(v.value0, Data_Int.toNumber((n * 6 | 0) + 1 | 0), tempo * stac, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 3 | 0), tempo * stac, true), new PVD(v.value2, Data_Int.toNumber((n * 6 | 0) + 5 | 0), tempo * stac, true), new PVD(v.value3, Data_Int.toNumber((n * 6 | 0) + 7 | 0), tempo * stac, true), new PVD(v.value4, Data_Int.toNumber((n * 6 | 0) + 9 | 0), tempo * stac, true), new PVD(v.value5, Data_Int.toNumber((n * 6 | 0) + 11 | 0), tempo * stac, true), new PVD(v.value6, Data_Int.toNumber(n * 6 | 0), tempo * 6.5, true), new PVD(v.value7, Data_Int.toNumber((n * 6 | 0) + 2 | 0), tempo * stac, true), new PVD(v.value8, Data_Int.toNumber((n * 6 | 0) + 4 | 0), tempo * stac, true), new PVD(v.value9, Data_Int.toNumber((n * 6 | 0) + 6 | 0), tempo * 6.5, true), new PVD(v.value10, Data_Int.toNumber((n * 6 | 0) + 8 | 0), tempo * stac, true), new PVD(v.value11, Data_Int.toNumber((n * 6 | 0) + 10 | 0), tempo * stac, true) ];
      };
  };
  var hocket1 = function (n) {
      return function (v) {
          return [ new PVD(v.value0, Data_Int.toNumber(n * 6 | 0), tempo * 4.5, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 1 | 0), tempo * stac, true), new PVD(v.value2, Data_Int.toNumber((n * 6 | 0) + 3 | 0), tempo * stac, true), new PVD(v.value3, Data_Int.toNumber((n * 6 | 0) + 5 | 0), tempo * stac, true), new PVD(v.value4, Data_Int.toNumber((n * 6 | 0) + 7 | 0), tempo * stac, true), new PVD(v.value5, Data_Int.toNumber((n * 6 | 0) + 9 | 0), tempo * stac, true), new PVD(v.value6, Data_Int.toNumber((n * 6 | 0) + 11 | 0), tempo * stac, true), new PVD(v.value7, Data_Int.toNumber(n * 6 | 0), tempo * 6.5, true), new PVD(v.value8, Data_Int.toNumber((n * 6 | 0) + 2 | 0), tempo * stac, true), new PVD(v.value9, Data_Int.toNumber((n * 6 | 0) + 4 | 0), tempo * stac, true), new PVD(v.value10, Data_Int.toNumber((n * 6 | 0) + 6 | 0), tempo * 6.5, true), new PVD(v.value11, Data_Int.toNumber((n * 6 | 0) + 8 | 0), tempo * stac, true), new PVD(v.value12, Data_Int.toNumber((n * 6 | 0) + 10 | 0), tempo * stac, true) ];
      };
  };
  var hocket0 = function (n) {
      return function (v) {
          return function (p) {
              return [ new PVD(v.value0, Data_Int.toNumber(n * 6 | 0), tempo * 4.5, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 1 | 0), tempo * stac, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 3 | 0), tempo * stac, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 5 | 0), tempo * stac, true), new PVD(v.value2, Data_Int.toNumber(n * 6 | 0), tempo * p, true), new PVD(v.value3, Data_Int.toNumber((n * 6 | 0) + 2 | 0), tempo * stac, true), new PVD(v.value4, Data_Int.toNumber((n * 6 | 0) + 4 | 0), tempo * stac, true) ];
          };
      };
  };
  var harmT = function (i) {
      return function (t) {
          return Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return new PVD(tpz(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v.value0 - i | 0)(12))(t) + v.value0 | 0, v.value1, v.value2, v.value3);
          });
      };
  };
  var gn = function (s) {
      return function (p) {
          var ht = split(s)(p);
          var left = Data_Maybe.fromMaybe(new Data_Tuple.Tuple(0.0, 0.0))(Data_Array.last(ht.init));
          var right = Data_Maybe.fromMaybe(new Data_Tuple.Tuple(101.0, 0.0))(Data_Array.head(ht.rest));
          var $84 = Data_Tuple.fst(right) - s < kr;
          if ($84) {
              return {
                  param: Data_Tuple.snd(right),
                  timeOffset: Data_Tuple.fst(right) - s
              };
          };
          var m = (Data_Tuple.snd(right) - Data_Tuple.snd(left)) / (Data_Tuple.fst(right) - Data_Tuple.fst(left));
          var b = Data_Tuple.snd(right) - m * Data_Tuple.fst(right);
          return {
              param: m * s + b,
              timeOffset: 0.0
          };
  ...
  var harp = function (name) {
      return function (t) {
          return function (s) {
              return function (dur) {
                  return function (doRelease) {
                      return Data_Semigroup.append(Data_List_Types.semigroupList)((function () {
                          var $85 = t + kr > s && t < s + dur + kr;
                          if ($85) {
                              return Control_Applicative.pure(Data_List_Types.applicativeList)(FRP_Behavior_Audio["gainT_'"](Data_Typelevel_Num_Sets.posD2)(name + ("g_g" + Data_Show.show(Data_Show.showNumber)(s)))(gn(t)(pwf(s)(dur)))(FRP_Behavior_Audio.playBufT_(Data_Typelevel_Num_Sets.posD2)(name + ("_" + Data_Show.show(Data_Show.showNumber)(s)))(name)({
                                  param: 1.0,
                                  timeOffset: Data_Ord.max(Data_Ord.ordNumber)(s - t)(0.0)
                              })));
                          };
                          return Data_List_Types.Nil.value;
                      })())((function () {
                          var $86 = doRelease && (t >= (s - 0.2) + dur + kr && t < (s - 0.2) + dur + kr + 3.0);
                          if ($86) {
                              return Control_Applicative.pure(Data_List_Types.applicativeList)(FRP_Behavior_Audio.playBufT_(Data_Typelevel_Num_Sets.posD2)(name + ("_" + (Data_Show.show(Data_Show.showNumber)(s) + "r")))(name + "r")({
                                  param: 1.0,
                                  timeOffset: Data_Ord.max(Data_Ord.ordNumber)(s - t)(0.0)
                              }));
                          };
  ...
  var scene = function (pc) {
      return function (t) {
          return Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(FRP_Behavior_Audio.speaker(Data_Typelevel_Num_Sets.posD2)(new Data_NonEmpty.NonEmpty(Data_Semiring.zero(FRP_Behavior_Audio.semiringAudioUnit), Control_Bind.join(Data_List_Types.bindList)(Data_Functor.map(Data_List_Types.functorList)(function (v) {
              return harp(Data_Show.show(Data_Show.showInt)(v.value0 + 0 | 0))(t)(tempo * v.value1)(v.value2)(v.value3);
          })(pc)))));
      };
  };
  var endOfPhrase = function (n) {
      return function (v) {
          return [ new PVD(v.value0, Data_Int.toNumber(n * 6 | 0), tempo * 4.5, true), new PVD(v.value1, Data_Int.toNumber((n * 6 | 0) + 4 | 0), tempo * 5.5, true), new PVD(v.value2, Data_Int.toNumber((n * 6 | 0) + 8 | 0), tempo * stac, false), new PVD(v.value3, Data_Int.toNumber((n * 6 | 0) + 9 | 0), tempo * stac, false), new PVD(v.value4, Data_Int.toNumber((n * 6 | 0) + 10 | 0), tempo * stac, false), new PVD(v.value5, Data_Int.toNumber((n * 6 | 0) + 11 | 0), tempo * stac, false) ];
      };
  };
  var endCursorOffset = 0;
  var dl = function (ctx) {
      return function (prev) {
          return function (s) {
              return Control_Bind.join(Control_Bind.bindArray)(Data_Functor.map(Data_Functor.functorArray)(function (i) {
                  var $100 = Foreign_Object.member(Data_Show.show(Data_Show.showInt)(i) + s)(prev);
                  if ($100) {
                      return [  ];
                  };
                  return [ Data_Tuple.Tuple.create(Data_Show.show(Data_Show.showInt)(i) + s)(Control_Parallel_Class.parallel(Effect_Aff.parallelAff)(Control_Promise.toAffE(FRP_Behavior_Audio.decodeAudioDataFromUri(ctx)("https://sound.klank.dev/petit-italien-k2/jeu-1/" + (Data_Show.show(Data_Show.showInt)(i) + (s + ".mp3")))))) ];
              })(Data_Array.range(12)(63)));
          };
      };
  };
  var chord = function (n) {
      return function (b) {
          return function (l) {
              return function (a) {
                  return Data_Functor.map(Data_Functor.functorArray)(function (x) {
                      return new PVD(x, Data_Int.toNumber(b + (n * 6 | 0) | 0), tempo * l, true);
                  })(a);
              };
          };
      };
  };
  var piece = Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(0)([ 54, 50, 45, 50, 54, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(0)(new Data_Tuple.Tuple(26, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(1)([ 55, 50, 55, 50, 55, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(1)(new Data_Tuple.Tuple(28, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(2)([ 57, 50, 57, 50, 57, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(2)(new Data_Tuple.Tuple(30, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(3)([ 59, 50, 59, 50, 59, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(3)(new Data_Tuple.Tuple(31, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(4)([ 57, 50, 57, 50, 57, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(4)(new Data_Tuple.Tuple(30, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(5)([ 55, 54, 52, 54, 55, 52 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(5)(new Data_Tuple.Tuple(28, 37)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(6)([ 54, 52, 50, 52, 54, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(endOfPhrase(6)(new EOP(26, 38, 37, 35, 33, 35)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(7)([ 52, 54, 52, 50, 49, 47 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(8)([ 37, 33, 28, 33, 37, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(8)(new Data_Tuple.Tuple(45, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(9)([ 38, 33, 38, 33, 38, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(9)(new Data_Tuple.Tuple(47, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(10)([ 40, 33, 40, 33, 40, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(10)(new Data_Tuple.Tuple(49, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(11)([ 42, 33, 42, 33, 42, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(11)(new Data_Tuple.Tuple(50, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(12)([ 40, 33, 40, 33, 40, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(12)(new Data_Tuple.Tuple(49, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(13)([ 38, 37, 35, 37, 38, 35 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(13)(new Data_Tuple.Tuple(47, 56)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(14)([ 37, 35, 33, 35, 37, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(endOfPhrase(14)(new EOP(45, 57, 55, 54, 52, 54)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(15)([ 35, 36, 35, 33, 31, 30 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(harmT(2)(M2.value)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(16)([ 54, 50, 45, 50, 54, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(16)(new Data_Tuple.Tuple(26, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(17)([ 55, 50, 55, 50, 55, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(17)(new Data_Tuple.Tuple(28, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(18)([ 57, 50, 57, 50, 57, 50 ]))(twom(18)(new Data_Tuple.Tuple(30, 38)))))))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(19)([ 60, 52, 60, 52, 60, 52 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(harmT(2)(M2.value)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(19)(new Data_Tuple.Tuple(31, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(20)([ 57, 50, 57, 50, 57, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(20)(new Data_Tuple.Tuple(30, 38)))(stdm(21)([ 55, 54, 52, 54, 55, 52 ]))))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(21)(new Data_Tuple.Tuple(30, 39)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(harmT(2)(M2.value)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(22)([ 54, 52, 50, 52, 54, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(endOfPhrase(22)(new EOP(26, 38, 37, 35, 33, 35)))(stdm(23)([ 52, 54, 52, 50, 49, 47 ])))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(harmT(2)(M2.value)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(24)([ 37, 33, 28, 33, 37, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(24)(new Data_Tuple.Tuple(45, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(25)([ 38, 33, 38, 33, 38, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(25)(new Data_Tuple.Tuple(47, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(26)([ 40, 33, 40, 33, 40, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(26)(new Data_Tuple.Tuple(49, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(27)([ 42, 33, 42, 33, 42, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(27)(new Data_Tuple.Tuple(50, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(28)([ 40, 33, 40, 33, 40, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(28)(new Data_Tuple.Tuple(49, 57)))(stdm(29)([ 38, 37, 35, 37, 38, 35 ])))))))))))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(29)(new Data_Tuple.Tuple(49, 58)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(m30ToM31)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(seq8$prime(32)(new Seq8(57, 45, 57, 55, 54)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmm(30)(38))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(31)(41))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(32)([ 42, 41, 42, 44, 42, 40 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(33)(39))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(seq8(34)(new Seq8(40, 28, 40, 38, 37)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(seq8(36)(new Seq8(38, 26, 38, 37, 35)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmm(34)(55))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(35)(58))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(36)([ 59, 58, 59, 61, 59, 57 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(37)(56))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(seq8(38)(new Seq8(57, 45, 57, 55, 54)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(seq8(40)(new Seq8(55, 43, 55, 54, 52)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(38)(37))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(39)(39))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(40)([ 40, 39, 40, 42, 40, 38 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(41)(37))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(seq8(42)(new Seq8(38, 26, 38, 36, 35)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(seq8(44)(new Seq8(36, 24, 36, 35, 33)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(42)(54))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(43)(56))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(44)([ 57, 56, 57, 59, 57, 55 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdmM(45)(54))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return new PVD(v.value0 - 2 | 0, v.value1, v.value2, v.value3);
  })(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(46)([ 37, 33, 28, 33, 37, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(46)(new Data_Tuple.Tuple(45, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(47)([ 38, 33, 38, 33, 38, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(47)(new Data_Tuple.Tuple(47, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(48)([ 40, 33, 40, 33, 40, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(48)(new Data_Tuple.Tuple(49, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(49)([ 42, 33, 42, 33, 42, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(49)(new Data_Tuple.Tuple(50, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(50)([ 40, 33, 40, 33, 40, 33 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(50)(new Data_Tuple.Tuple(49, 57)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(51)([ 38, 37, 35, 37, 38, 35 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(51)(new Data_Tuple.Tuple(47, 56)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(52)([ 37, 35, 33, 35, 37, 33 ]))(endOfPhrase(52)(new EOP(45, 57, 56, 54, 52, 54)))))))))))))))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(53)([ 33, 35, 33, 31, 30, 28 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(54)([ 54, 50, 45, 50, 54, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(54)(new Data_Tuple.Tuple(26, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(55)([ 55, 50, 55, 50, 55, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(55)(new Data_Tuple.Tuple(28, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(56)([ 57, 50, 57, 50, 57, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(56)(new Data_Tuple.Tuple(30, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(57)([ 59, 50, 59, 50, 59, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(57)(new Data_Tuple.Tuple(31, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(58)([ 57, 50, 57, 50, 57, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(58)(new Data_Tuple.Tuple(30, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(59)([ 55, 54, 52, 54, 55, 52 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(59)(new Data_Tuple.Tuple(28, 37)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(60)([ 54, 52, 50, 52, 54, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(twom(60)(new Data_Tuple.Tuple(26, 38)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(61)([ 52, 54, 52, 50, 49, 47 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(m61)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(62)(new Hocket0(49, 45, 33, 43, 40))(6.5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(63)(new Hocket0(49, 45, 33, 43, 40))(6.3))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(64)(new Hocket0(50, 45, 33, 42, 38))(6.8))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(65)(new Hocket0(50, 45, 33, 42, 38))(6.5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(66)(new Hocket0(55, 45, 33, 40, 37))(6.3))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(67)(new Hocket0(55, 45, 33, 40, 37))(6.1))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(68)(new Hocket0(54, 45, 33, 42, 38))(6.3))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(69)(new Hocket0(54, 45, 33, 42, 38))(6.5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(70)(new Hocket0(56, 47, 33, 41, 38))(6.8))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(71)(new Hocket0(56, 47, 33, 41, 38))(6.5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(72)(new Hocket0(57, 49, 33, 40, 37))(6.3))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(73)(new Hocket0(57, 49, 31, 40, 37))(6.1))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket1(74)(new Hocket1(57, 50, 45, 50, 54, 57, 59, 30, 42, 38, 33, 30, 28)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(76)([ 60, 59, 57, 55, 54, 52 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(77)([ 54, 55, 57, 60, 59, 57 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(threeDots(76)(new ThreeDots(27, 30, 35)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(threeDots(77)(new ThreeDots(39, 42, 45)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket1(78)(new Hocket1(59, 52, 43, 47, 52, 55, 57, 43, 40, 35, 31, 28, 26)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return new PVD(v.value0 - 2 | 0, v.value1, v.value2, v.value3);
  })(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(80)([ 60, 59, 57, 55, 54, 52 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(81)([ 54, 55, 57, 60, 59, 57 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(threeDots(80)(new ThreeDots(27, 30, 35)))(threeDots(81)(new ThreeDots(39, 42, 45)))))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket1(82)(new Hocket1(57, 50, 53, 50, 46, 43, 52, 41, 38, 34, 31, 40, 37)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket2(84)(new Hocket2(45, 41, 50, 46, 43, 40, 29, 38, 34, 31, 28, 25)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return new PVD(v.value0 - 12 | 0, v.value1, v.value2, v.value3);
  })(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(86)(new Hocket0(49, 45, 33, 43, 40))(6.2))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(87)(new Hocket0(49, 45, 33, 43, 40))(6.5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(88)(new Hocket0(50, 45, 33, 42, 38))(6.3))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(89)(new Hocket0(50, 45, 33, 42, 38))(6.5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(90)(new Hocket0(55, 45, 33, 40, 37))(6.8))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(91)(new Hocket0(55, 45, 33, 40, 37))(6.1))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(92)(new Hocket0(54, 45, 33, 42, 38))(6.3))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(93)(new Hocket0(54, 45, 33, 42, 38))(6.5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(hocket0(94)(new Hocket0(56, 47, 33, 41, 38))(6.3))(hocket0(95)(new Hocket0(56, 47, 33, 41, 38))(6.1))))))))))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(96)([ 21, 25, 28, 31, 34, 37 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(97)([ 38, 41, 44, 47, 50, 53 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ new PVD(21, Data_Int.toNumber(98 * 6 | 0), tempo * 6.5, true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(98)([ 49, 52, 55, 52, 49, 45 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(99)([ 43, 40, 37, 33, 37, 40 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ new PVD(33, Data_Int.toNumber(100 * 6 | 0), tempo * 6.5, true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(100)([ 42, 45, 50, 45, 42, 38 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(stdm(101)([ 35, 32, 29, 26, 29, 32 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ new PVD(21, Data_Int.toNumber(((102 - endCursorOffset | 0) * 6 | 0) + 1 | 0), tempo * 12.0, true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(chord(102 - endCursorOffset | 0)(5)(7.4)([ 26, 30, 33, 42, 45, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(chord(102 - endCursorOffset | 0)(11)(7.4)([ 28, 31, 33, 40, 45, 49 ]))(chord(102 - endCursorOffset | 0)(18)(60.0)([ 26, 30, 33, 38, 45, 50 ])))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
  var buffers = function (ctx) {
      return function (prev) {
          return Data_Functor.map(Effect_Aff.functorAff)(Foreign_Object.union(prev))(Control_Parallel_Class.sequential(Effect_Aff.parallelAff)(Data_Traversable.sequence(Foreign_Object.traversableObject)(Effect_Aff.applicativeParAff)(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dl(ctx)(prev)(""))(dl(ctx)(prev)("r"))))));
      };
  };
  var main = function (ctx) {
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(buffers(ctx)(Foreign_Object.empty))(function (bufs) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Behavior_Audio.runInBrowser_(FRP_Behavior_Audio.soundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD2))(function __do() {
              var randy = Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Functor.map(Data_Functor.functorArray)(Data_Function["const"](function __do() {
                  var r0 = Effect_Random.random();
                  var r1 = Effect_Random.random();
                  return new Data_Tuple.Tuple(r0, r1);
              }))(Data_Array.range(0)(Data_Array.length(piece) - 1 | 0)))();
              var additiveJank = Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Functor.map(Data_Functor.functorArray)(Data_Function["const"](Effect_Random.random))(Data_Array.range(0)(Data_Array.length(piece) - 1 | 0)))();
              var smaller = Data_Functor.map(Data_Functor.functorArray)(function (a) {
                  return new Data_Tuple.Tuple(Data_Tuple.fst(a) * 5.0e-3, Data_Tuple.snd(a) * 5.0e-3);
              })(randy);
              var pjanked = Data_Array.zipWith(function (aj) {
                  return function (v) {
                      return new PVD(v.value0, v.value1 + 2.0e-2 * Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Semiring.add(Data_Semiring.semiringNumber))(0.0)(Data_Array.take(aj)(additiveJank)), v.value2, v.value3);
                  };
              })(Data_Array.range(0)(Data_Array.length(additiveJank) - 1 | 0))(Data_Array.zipWith(function (v) {
                  return function (v1) {
                      return new PVD(v1.value0, v1.value1 + v.value0, v1.value2 + v.value1, v1.value3);
                  };
              })(smaller)(piece));
              return scene(Data_List.fromFoldable(Data_Foldable.foldableArray)(pjanked));
          })(Data_Unit.unit)(ctx)({
              msBetweenSamples: 20,
              msBetweenPings: 15,
              ...
              microphones: Foreign_Object.empty,
              tracks: Foreign_Object.empty,
              buffers: bufs
          })({
              canvases: Foreign_Object.empty
          })(FRP_Behavior_Audio.defaultExporter));
      }));
  };
  exports["kr"] = kr;
  exports["pwf"] = pwf;
  ...
  exports["chord"] = chord;
  exports["twom"] = twom;
  exports["m30ToM31"] = m30ToM31;
  exports["m61"] = m61;
  exports["endOfPhrase"] = endOfPhrase;
  exports["Seq8"] = Seq8;
  exports["seq8'"] = seq8$prime;
  exports["seq8"] = seq8;
  exports["hocket0"] = hocket0;
  exports["hocket1"] = hocket1;
  exports["hocket2"] = hocket2;
  ...
  exports["harmT"] = harmT;
  exports["piece"] = piece;
  exports["endCursorOffset"] = endCursorOffset;
  exports["stdmM"] = stdmM;
  exports["stdmm"] = stdmm;
  exports["PVD"] = PVD;
  exports["scene"] = scene;
...
PS["FRP.Behavior.Audio.Example.Bach"].main();