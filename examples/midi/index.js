  ...
  var afterTimeStampIfExists = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at FRP.Behavior.Audio.Example.MIDI (line 33, column 1 - line 33, column 70): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
              ...
              var go = function ($copy_v) {
                  return function ($copy_v1) {
                      ...
                      function $tco_loop(v, v1) {
                          ...
                          throw new Error("Failed pattern match at FRP.Behavior.Audio.Example.MIDI (line 47, column 3 - line 47, column 47): " + [ v.constructor.name, v1.constructor.name ]);
                      };
                      while (!$tco_done) {
                  ...
                  var f = function (cl) {
                      return function (md) {
                          var newCorrection = (function () {
                              ...
                              throw new Error("Failed pattern match at FRP.Behavior.Audio.Example.MIDI (line 95, column 21 - line 100, column 23): " + [ acc.syncWithAudioClock.constructor.name ]);
                          })();
