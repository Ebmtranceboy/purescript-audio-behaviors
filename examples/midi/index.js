...
(function($PS) {
  ...
  var IAudioUnit = (function () {
      function IAudioUnit(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      IAudioUnit.create = function (value0) {
          return function (value1) {
              return new IAudioUnit(value0, value1);
          };
      };
      return IAudioUnit;
  })();
  ...
  var gain_$prime = function (dictPos) {
      return function (s) {
          return function (n) {
              var $5150 = Gain.create(new Data_Maybe.Just(s))(ap_(n));
              var $5151 = Data_NonEmpty.singleton(Data_List_Types.plusList);
              return function ($5152) {
                  return $5150($5151($5152));
              };
          };
      };
  };
  var sawtoothOsc_ = function (s) {
      return function (n) {
          return new SawtoothOsc(new Data_Maybe.Just(s), ap_(n));
      };
  };
  ...
  var iSoundscapeRunnableMedia = function (dictPos) {
                          ...
                          return function (vi) {
                              return function (ex) {
                                  return runInBrowser(avRunnableMedia(dictPos))(function (z) {
                                      return function (wh) {
                                          return function (s) {
                                              return Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(function (v) {
                                                  return new AV(new Data_Maybe.Just(v.value0), Data_Maybe.Nothing.value, v.value1);
                                              })(f(z)(s));
                                          };
                                      };
                                  })(a)(ac)(ei)(ai)(vi)(ex);
  ...
  exports["gain"] = gain;
  exports["sawtoothOsc_"] = sawtoothOsc_;
  exports["speaker'"] = speaker$prime;
  exports["gain_'"] = gain_$prime;
  exports["defaultExporter"] = defaultExporter;
  exports["IAudioUnit"] = IAudioUnit;
  exports["runInBrowser"] = runInBrowser;
  exports["semiringAudioUnit"] = semiringAudioUnit;
  exports["iSoundscapeRunnableMedia"] = iSoundscapeRunnableMedia;
})(PS);
(function(exports) {
...
(function($PS) {
  ...
  var withMidi = function (v) {
      return function (e) {
          return FRP_Event.makeEvent(function (k) {
              return FRP_Event.subscribe(e)(function (value) {
                  return function __do() {
                      var midi_ = Effect_Ref.read(v.midi)();
                      return k({
                          value: value,
                          midi: midi_
                      })();
  ...
  var getMidi = function (midiAccess_) {
      return function __do() {
          var targetMap = Control_Bind.bind(Effect.bindEffect)($foreign.toTargetMap(midiAccess_))((function () {
              var $13 = Control_Applicative.pure(Effect.applicativeEffect);
              var $14 = Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_List_Types.foldableList);
              var $15 = Foreign_Object.toUnfoldable(Data_List_Types.unfoldableList);
              return function ($16) {
                  return $13($14($15($16)));
              };
          })())();
          var midi = Effect_Ref["new"](Data_Map_Internal.empty)();
          var makeListener = function (inputName) {
                  ...
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(function (me) {
                      return function __do() {
                          ...
                          if (toAdd_ instanceof Data_Maybe.Just) {
                              Effect_Ref.modify(function (mmap) {
                                  return Data_Map_Internal.union(Data_Ord.ordString)(Data_Map_Internal.singleton(inputName)(new Data_List_Types.Cons(toAdd_.value0, Data_Maybe.fromMaybe(Data_List_Types.Nil.value)(Data_Map_Internal.lookup(Data_Ord.ordString)(inputName)(mmap)))))(mmap);
                              })(midi)();
                              return Data_Unit.unit;
                          };
                          throw new Error("Failed pattern match at FRP.Event.MIDI (line 120, column 15 - line 139, column 20): " + [ toAdd_.constructor.name ]);
                      };
                  })(fromEvent(e));
              });
          };
          var listeners = Data_Traversable.sequence(Data_Map_Internal.traversableMap)(Effect.applicativeEffect)(Data_Map_Internal.mapMaybeWithKey(Data_Ord.ordString)(function (k) {
              return function (v) {
                  return new Data_Maybe.Just(function __do() {
                      ...
                      Web_Event_EventTarget.addEventListener(Data_Newtype.wrap(Web_Event_Event.newtypeEventType)("midimessage"))(listener)(false)(v)();
                      return new Data_Tuple.Tuple(listener, v);
                  });
              };
          })(targetMap))();
          var dispose = function __do() {
              Data_Traversable.sequence(Data_Map_Internal.traversableMap)(Effect.applicativeEffect)(Data_Map_Internal.mapMaybeWithKey(Data_Ord.ordString)(function (k) {
                  return function (v) {
                      return new Data_Maybe.Just(Web_Event_EventTarget.removeEventListener(Data_Newtype.wrap(Web_Event_Event.newtypeEventType)("midimessage"))(v.value0)(false)(v.value1));
                  };
              })(listeners))();
              return Data_Unit.unit;
          };
  ...
  exports["withMidi"] = withMidi;
  exports["midiAccess"] = $foreign.midiAccess;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.MIDI"] = $PS["FRP.Behavior.MIDI"] || {};
  var exports = $PS["FRP.Behavior.MIDI"];
  var Data_Functor = $PS["Data.Functor"];
  var FRP_Behavior = $PS["FRP.Behavior"];
  var FRP_Event = $PS["FRP.Event"];
  ...
  var midi = function (m) {
      return FRP_Behavior.behavior(function (e) {
          return Data_Functor.map(FRP_Event.functorEvent)(function (v) {
              return v.value(v.midi);
          })(FRP_Event_MIDI.withMidi(m)(e));
      });
  };
  exports["midi"] = midi;
})(PS);
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.MIDI"] = $PS["FRP.Behavior.Audio.Example.MIDI"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.MIDI"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var FRP_Behavior_MIDI = $PS["FRP.Behavior.MIDI"];
  ...
  var Foreign_Object = $PS["Foreign.Object"];
  var $$Math = $PS["Math"];                
  var runWithMidi = function (callback) {
      return function (ac) {
          return function (ctx) {
              return function (ei) {
                  return function (ai) {
                      return function (vi) {
                          return function (ex) {
                              return function __do() {
                                  var fiber = Effect_Aff.launchAff(Control_Bind.bind(Effect_Aff.bindAff)(Control_Promise.toAffE(FRP_Event_MIDI.midiAccess))(function (macc) {
                                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Event_MIDI.getMidi(macc)))(function (md) {
                                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Event_Mouse.getMouse))(function (mouse) {
                                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Behavior_Audio.runInBrowser(FRP_Behavior_Audio.iSoundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD1))(callback(mouse)(md))(ac)(ctx)(ei)(ai)(vi)(ex));
                                          });
                                      });
                                  }))();
                                  var rest = Effect_Aff.joinFiber(fiber);
                                  return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(rest)(function (o) {
                                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(o);
                                  }));
                              };
                          };
                      };
  ...
  var midi2cps = function (i) {
      return 440.0 * $$Math.pow(2.0)(Data_Int.toNumber(Debug_Trace.spy()("midi")(i) - 69 | 0) / 12.0);
  };
  var initialClock = {
      syncWithAudioClock: new Data_Maybe.Just(0.0)
  };
  var gen = FRP_Behavior_Audio.sawtoothOsc_;
  var afterTimeStampIfExists = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              if (v2 instanceof Data_Maybe.Just) {
                  return v1 - v2.value0 < v;
              };
              throw new Error("Failed pattern match at FRP.Behavior.Audio.Example.MIDI (line 34, column 1 - line 34, column 70): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var synth = function (time) {
      return function (timeCorrection) {
          return function (m) {
              var go = function ($copy_v) {
                  return function ($copy_v1) {
                      var $tco_var_v = $copy_v;
                      ...
                      function $tco_loop(v, v1) {
                          ...
                          if (v1 instanceof Data_List_Types.Cons && v1.value0.event instanceof FRP_Event_MIDI.NoteOn) {
                              if (afterTimeStampIfExists(time)(v1.value0.timeStamp / 1000.0)(timeCorrection)) {
                                  $tco_var_v = {
                                      off: Data_Semigroup.append(Data_Set.semigroupSet(Data_Ord.ordInt))(Data_Set.singleton(v1.value0.event.value1))(v.off),
                                      on: (function () {
                                          var $13 = !Data_Set.member(Data_Ord.ordInt)(v1.value0.event.value1)(v.off);
                                          if ($13) {
                                              return Data_Semigroup.append(Data_Set.semigroupSet(Data_Ord.ordInt))(Data_Set.singleton(v1.value0.event.value1))(v.on);
                                          };
                                          return v.on;
                                      })()
                                  };
                          ...
                          if (v1 instanceof Data_List_Types.Cons && v1.value0.event instanceof FRP_Event_MIDI.NoteOff) {
                              if (afterTimeStampIfExists(time - 0.1)(v1.value0.timeStamp / 1000.0)(timeCorrection)) {
                                  $tco_var_v = {
                                      off: Data_Semigroup.append(Data_Set.semigroupSet(Data_Ord.ordInt))(Data_Set.singleton(v1.value0.event.value1))(v.off),
                                      on: v.on
                                  };
                          ...
                          throw new Error("Failed pattern match at FRP.Behavior.Audio.Example.MIDI (line 48, column 3 - line 48, column 47): " + [ v.constructor.name, v1.constructor.name ]);
                      };
                      while (!$tco_done) {
              ...
              return Data_Maybe.fromMaybe(Data_Set.empty)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.head(Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray)(m)))(function (h) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((go({
                      off: Data_Set.empty,
                      on: Data_Set.empty
                  })(Data_Tuple.snd(h))).on);
              }));
  ...
  var scene = function (mouse) {
      return function (midiIn) {
          return function (acc) {
              return function (time) {
                  var rad = $$Math.pi * time;
                  var f = function (cl) {
                      return function (md) {
                          var newCorrection = (function () {
                              if (acc.syncWithAudioClock instanceof Data_Maybe.Nothing) {
                                  return Data_Functor.map(Data_Maybe.functorMaybe)(function (t) {
                                      return t / 1000.0 - time;
                                  })(Data_List.head(Data_List.sort(Data_Ord.ordNumber)(Data_Functor.map(Data_List_Types.functorList)(function (v) {
                                      return v.timeStamp;
                                  })(Data_Foldable.fold(Data_List_Types.foldableList)(Data_List_Types.monoidList)(Data_Map_Internal.values(md))))));
                              };
                              if (acc.syncWithAudioClock instanceof Data_Maybe.Just) {
                                  return new Data_Maybe.Just(acc.syncWithAudioClock.value0);
                              };
                              throw new Error("Failed pattern match at FRP.Behavior.Audio.Example.MIDI (line 96, column 21 - line 101, column 23): " + [ acc.syncWithAudioClock.constructor.name ]);
                          })();
                          return new FRP_Behavior_Audio.IAudioUnit(FRP_Behavior_Audio["speaker'"](Data_Typelevel_Num_Sets.posD1)(FRP_Behavior_Audio.gain(Data_Typelevel_Num_Sets.posD1)(0.1)(new Data_NonEmpty.NonEmpty(Data_Semiring.zero(FRP_Behavior_Audio.semiringAudioUnit), Data_Functor.map(Data_List_Types.functorList)(function (i) {
                              return FRP_Behavior_Audio["gain_'"](Data_Typelevel_Num_Sets.posD1)("gain" + Data_Show.show(Data_Show.showInt)(i))(0.4)(gen("sinOsc" + Data_Show.show(Data_Show.showInt)(i))(midi2cps(i) + (function () {
                                  var $36 = !cl;
                                  if ($36) {
                                      return 0.0;
                                  };
                                  return 10.0 * $$Math.sin(7.0 * rad);
                              })()));
                          })(Data_List.fromFoldable(Data_Set.foldableSet)(synth(time)(newCorrection)(md)))))), (function () {
                              var $37 = {};
                              for (var $38 in acc) {
                                  if ({}.hasOwnProperty.call(acc, $38)) {
                                      $37[$38] = acc[$38];
                                  };
                              };
                              $37.syncWithAudioClock = newCorrection;
                              return $37;
                          })());
                      };
                  };
                  var click = Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))((function () {
                      var $40 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                      return function ($41) {
                          return $40(Data_Set.isEmpty($41));
                      };
                  })())(FRP_Behavior_Mouse.buttons(mouse));
                  return Control_Apply.apply(FRP_Behavior.applyABehavior(FRP_Event.functorEvent))(Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(f)(click))(FRP_Behavior_MIDI.midi(midiIn));
              };
          };
      };
  };
  var main = function (ctx) {
      return runWithMidi(scene)(initialClock)(ctx)({
          msBetweenSamples: 20,
          msBetweenPings: 15,
  ...
  exports["gen"] = gen;
  exports["afterTimeStampIfExists"] = afterTimeStampIfExists;
  exports["synth"] = synth;
  exports["midi2cps"] = midi2cps;
  exports["initialClock"] = initialClock;
  exports["scene"] = scene;
  exports["runWithMidi"] = runWithMidi;
  exports["main"] = main;
})(PS);
PS["FRP.Behavior.Audio.Example.MIDI"].main();