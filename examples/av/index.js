...
(function($PS) {
  ...
  exports["avRunnableMedia"] = avRunnableMedia;
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.AV"] = $PS["FRP.Behavior.Audio.Example.AV"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.AV"];
  var Color = $PS["Color"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
          ...
          return function (v1) {
              return function (time) {
                  var split = function (s) {
                      return Data_Array.span(function ($27) {
                          return (function (v2) {
                              return s >= v2;
                          })(Data_Tuple.fst($27));
                      })(pwf);
                  ...
                  var gn = function (s) {
                      ...
                      var $13 = Data_Tuple.fst(right) - s < kr;
                      if ($13) {
                          return {
                  ...
                  var f = function (s) {
                      return function (cl) {
                          var stTime = (function () {
                              var v2 = new Data_Tuple.Tuple(v.onset, cl);
                              if (v2.value0 instanceof Data_Maybe.Nothing && v2.value1) {
                                  return new Data_Maybe.Just(s);
                              };
                              if (v2.value0 instanceof Data_Maybe.Just && v2.value1) {
                                  return new Data_Maybe.Just(v2.value0.value0);
                              };
                              if (!v2.value1) {
                                  return Data_Maybe.Nothing.value;
                              };
                              throw new Error("Failed pattern match at FRP.Behavior.Audio.Example.AV (line 95, column 14 - line 98, column 33): " + [ v2.constructor.name ]);
                          })();
                          var rad = $$Math.pi * s;
                          return new FRP_Behavior_Audio.AV(Data_Maybe.Just.create(FRP_Behavior_Audio.dup1(Data_Typelevel_Num_Sets.posD2)(Data_Semiring.add(FRP_Behavior_Audio.semiringAudioUnit)(Data_Semiring.add(FRP_Behavior_Audio.semiringAudioUnit)(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.2)(FRP_Behavior_Audio.sinOsc(110.0 + 3.0 * $$Math.sin(0.5 * rad))))(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.1)(FRP_Behavior_Audio["gainT'"](Data_Typelevel_Num_Sets.posD1)(gn(s))(FRP_Behavior_Audio.sinOsc(440.0)))))(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.1)(FRP_Behavior_Audio.sinOsc(220.0 + (function () {
                              if (cl) {
                          ...
                          })), Data_Maybe.Just.create(Graphics_Drawing.filled(Graphics_Drawing.fillColor(Color.rgb(0)(0)(0)))(Graphics_Drawing.circle(v1.w / 2.0)(v1.h / 2.0)((function () {
                              if (cl) {
                                  return 25.0;
                              };
                              return 5.0;
  ...
  var main = function (ctx) {
      return function (canvas) {
          return function __do() {
              ...
              return FRP_Behavior_Audio.runInBrowser_(FRP_Behavior_Audio.avRunnableMedia(Data_Typelevel_Num_Sets.posD2))(function __do() {
                  ...
                  canvases: Foreign_Object.singleton("myCanvas")(canvas)
...
PS["FRP.Behavior.Audio.Example.AV"].main();