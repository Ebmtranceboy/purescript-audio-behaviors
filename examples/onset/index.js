...
(function($PS) {
  ...
  var play = function (dictPos) {
      return function (handle) {
          return new Play(Data_Maybe.Nothing.value, handle, 0.0);
      };
  };                          
  var os2s = function (o) {
  ...
  var merger = function (dictPos) {
      return Merger.create(Data_Maybe.Nothing.value);
  };
  ...
  var gainT$prime = function (dictPos) {
      return function (n) {
          var $5141 = Gain.create(Data_Maybe.Nothing.value)(n);
          var $5142 = Data_NonEmpty.singleton(Data_List_Types.plusList);
          return function ($5143) {
              return $5141($5142($5143));
          };
      };
  };                                                  
  ...
  var dup1 = function (dictPos) {
      return function (v) {
          return function (f) {
              if (v instanceof DupRes) {
                  return f(DupRes.value);
              };
              return new Dup1(Data_Maybe.Nothing.value, v, f);
          };
      };
  };
  var dummyCanvasInfo = {
  ...
  var gain$prime = function (dictPos) {
      return function (n) {
          var $5147 = Gain.create(Data_Maybe.Nothing.value)(ap_(n));
          var $5148 = Data_NonEmpty.singleton(Data_List_Types.plusList);
          return function ($5149) {
              return $5147($5148($5149));
          };
      };
  };
  var panner = function (n) {
      return StereoPanner.create(Data_Maybe.Nothing.value)(ap_(n));
  };
  ...
  var sinOsc = function (n) {
      return new SinOsc(Data_Maybe.Nothing.value, ap_(n));
  };
  ...
  exports["makeAudioTrack"] = $foreign.makeAudioTrack;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.Onset"] = $PS["FRP.Behavior.Audio.Example.Onset"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.Onset"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_HeytingAlgebra = $PS["Data.HeytingAlgebra"];
  ...
  var Foreign_Object = $PS["Foreign.Object"];
  var $$Math = $PS["Math"];                
  var pwf = Control_Bind.join(Control_Bind.bindArray)(Data_Functor.map(Data_Functor.functorArray)(function (i) {
      return Data_Functor.map(Data_Functor.functorArray)(function (v) {
          return new Data_Tuple.Tuple(v.value0 + 0.11 * Data_Int.toNumber(i), v.value1);
      })([ new Data_Tuple.Tuple(0.0, 0.0), new Data_Tuple.Tuple(2.0e-2, 0.7), new Data_Tuple.Tuple(6.0e-2, 0.2) ]);
      ...
      return function (v) {
          return function (time) {
              var split = function (s) {
                  return Data_Array.span(function ($22) {
                      return (function (v1) {
                          return s >= v1;
                      })(Data_Tuple.fst($22));
                  })(pwf);
              ...
              var gn = function (s) {
                  ...
                  var right = Data_Maybe.fromMaybe(new Data_Tuple.Tuple(201.0, 0.0))(Data_Array.head(ht.rest));
                  var $11 = Data_Tuple.fst(right) - s < kr;
                  if ($11) {
                      return {
              ...
              var f = function (s) {
                  return function (cl) {
                      var stTime = (function () {
                          var v1 = new Data_Tuple.Tuple(v.onset, cl);
                          if (v1.value0 instanceof Data_Maybe.Nothing && v1.value1) {
                              return new Data_Maybe.Just(s);
                          };
                          if (v1.value0 instanceof Data_Maybe.Just && v1.value1) {
                              return new Data_Maybe.Just(v1.value0.value0);
                          };
                          if (!v1.value1) {
                              return Data_Maybe.Nothing.value;
                          };
                          throw new Error("Failed pattern match at FRP.Behavior.Audio.Example.Onset (line 88, column 14 - line 91, column 33): " + [ v1.constructor.name ]);
                      })();
                      var rad = $$Math.pi * s;
                      return new FRP_Behavior_Audio.IAudioUnit(FRP_Behavior_Audio.dup1(Data_Typelevel_Num_Sets.posD2)(Data_Semiring.add(FRP_Behavior_Audio.semiringAudioUnit)(Data_Semiring.add(FRP_Behavior_Audio.semiringAudioUnit)(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.2)(FRP_Behavior_Audio.sinOsc(110.0 + 3.0 * $$Math.sin(0.5 * rad))))(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.1)(FRP_Behavior_Audio["gainT'"](Data_Typelevel_Num_Sets.posD1)(gn(s))(FRP_Behavior_Audio.sinOsc(440.0)))))(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.1)(FRP_Behavior_Audio.sinOsc(220.0 + (function () {
                          if (cl) {
                              return 50.0 + Data_Maybe.maybe(0.0)(function (t) {
                                  return 10.0 * (s - t);
                              })(stTime);
                          };
                          return 0.0;
                      })()))))(function (mono) {
                          return FRP_Behavior_Audio.speaker(Data_Typelevel_Num_Sets.posD2)(new Data_NonEmpty.NonEmpty(FRP_Behavior_Audio.panner(-0.5)(FRP_Behavior_Audio.merger(Data_Typelevel_Num_Sets.posD2)(Data_Vec.cons(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD2)()(Data_Typelevel_Num_Ops.divMod10D1D0)()(Data_Typelevel_Num_Ops.divMod10D2D0))(mono)(Data_Vec.cons(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD1)()(Data_Typelevel_Num_Ops.divMod10D0D0)()(Data_Typelevel_Num_Ops.divMod10D1D0))(mono)(Data_Vec.empty)))), new Data_List_Types.Cons(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD2)(0.5)(FRP_Behavior_Audio.play(Data_Typelevel_Num_Sets.posD2)("forest")), Data_List_Types.Nil.value)));
                      }), {
                          onset: stTime
                      });
                  };
              ...
              var click = Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))((function () {
                  ...
                  return function ($24) {
                      return $23(Data_Set.isEmpty($24));
                  };
              })())(FRP_Behavior_Mouse.buttons(mouse));
              return Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(f(time))(click);
          };
      };
  };
  var initialOnset = {
      onset: Data_Maybe.Nothing.value
  };
  var main = function (ctx) {
      return function __do() {
          var forest = FRP_Behavior_Audio.makeAudioTrack("https://freesound.org/data/previews/530/530415_1648170-lq.mp3")();
          return FRP_Behavior_Audio.runInBrowser_(FRP_Behavior_Audio.iSoundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD2))(function __do() {
              ...
              tracks: Foreign_Object.singleton("forest")(forest),
  ...
  exports["pwf"] = pwf;
  exports["kr"] = kr;
  exports["initialOnset"] = initialOnset;
  exports["scene"] = scene;
  exports["main"] = main;
})(PS);
PS["FRP.Behavior.Audio.Example.Onset"].main();