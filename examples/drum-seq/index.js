...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.DrumSequence"] = $PS["FRP.Behavior.Audio.Example.DrumSequence"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.DrumSequence"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Parallel_Class = $PS["Control.Parallel.Class"];
  ...
  var FRP_Event = $PS["FRP.Event"];
  var Foreign_Object = $PS["Foreign.Object"];                
  var withinWindow = function (t) {
      return function (krate) {
          return function (s) {
              return function (dur) {
                  return t + krate > s && t < s + dur + krate;
              };
          };
      };
  };
  var tempo = 60.0 / 90.0;
  var tempoize = function (n) {
      return tempo * n;
  };
  var split = function (s) {
      return function (p) {
          return Data_Array.span(function ($4) {
              return (function (v) {
                  return s >= v;
              })(Data_Tuple.fst($4));
          })(p);
  ...
  var gn = function (s) {
      return function (p) {
          ...
          var $1 = Data_Tuple.fst(right) - s < kr;
          if ($1) {
              return {
  ...
  var scene = function (time) {
      return Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(FRP_Behavior_Audio["speaker'"](Data_Typelevel_Num_Sets.posD2)(FRP_Behavior_Audio.gain(Data_Typelevel_Num_Sets.posD2)(1.0)(new Data_NonEmpty.NonEmpty(Data_Semiring.zero(FRP_Behavior_Audio.semiringAudioUnit), Data_Semigroup.append(Data_List_Types.semigroupList)(Data_Semigroup.append(Data_List_Types.semigroupList)(trigger("wavbvkery/Kicks/22.wav")(time)(tempoize(0.0))(2.0))(Data_Semigroup.append(Data_List_Types.semigroupList)(trigger("wavbvkery/Kicks/22.wav")(time)(tempoize(2.0))(2.0))(Data_Semigroup.append(Data_List_Types.semigroupList)(trigger("wavbvkery/Kicks/22.wav")(time)(tempoize(6.0))(2.0))(trigger("wavbvkery/Kicks/22.wav")(time)(tempoize(8.0))(2.0)))))(Data_Semigroup.append(Data_List_Types.semigroupList)(Data_Semigroup.append(Data_List_Types.semigroupList)(trigger("wavbvkery/Snares/09.wav")(time)(tempoize(1.0))(2.0))(Data_Semigroup.append(Data_List_Types.semigroupList)(trigger("wavbvkery/Snares/09.wav")(time)(tempoize(3.0))(2.0))(Data_Semigroup.append(Data_List_Types.semigroupList)(trigger("wavbvkery/Snares/09.wav")(time)(tempoize(5.0))(2.0))(trigger("wavbvkery/Snares/09.wav")(time)(tempoize(7.0))(2.0)))))(Control_Bind.join(Data_List_Types.bindList)(Data_Functor.map(Data_List_Types.functorList)(function (i) {
          return trigger("wavbvkery/Hats/02.wav")(time)(tempoize(0.0) + Data_Int.toNumber(i) * 0.5)(2.0);
      })(Data_List.range(0)(15)))))))));
  };
  var filez = [ "buchla/Tabla_9_bip.wav", "wavbvkery/Hats/02.wav", "wavbvkery/Snares/22.wav", "wavbvkery/Snares/09.wav", "wavbvkery/Kicks/22.wav" ];
  var dl = function (ctx) {
      return function (prev) {
          return Control_Bind.join(Control_Bind.bindArray)(Data_Functor.map(Data_Functor.functorArray)(function (i) {
              var $3 = Foreign_Object.member(i)(prev);
              if ($3) {
                  return [  ];
              };
              return [ Data_Tuple.Tuple.create(i)(Control_Parallel_Class.parallel(Effect_Aff.parallelAff)(Control_Promise.toAffE(FRP_Behavior_Audio.decodeAudioDataFromUri(ctx)("https://sound.klank.dev/" + i)))) ];
          })(filez));
      };
  };
  var buffers = function (ctx) {
      return function (prev) {
          return Data_Functor.map(Effect_Aff.functorAff)(Foreign_Object.union(prev))(Control_Parallel_Class.sequential(Effect_Aff.parallelAff)(Data_Traversable.sequence(Foreign_Object.traversableObject)(Effect_Aff.applicativeParAff)(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)(dl(ctx)(prev)))));
      };
  };
  var main = function (ctx) {
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(buffers(ctx)(Foreign_Object.empty))(function (b) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Behavior_Audio.runInBrowser(FRP_Behavior_Audio.soundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD2))(scene)(Data_Unit.unit)(ctx)({
              msBetweenSamples: 20,
              msBetweenPings: 15,
...
PS["FRP.Behavior.Audio.Example.DrumSequence"].main();