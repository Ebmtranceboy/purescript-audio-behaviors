...
(function($PS) {
  ...
  var loopBuf = function (dictPos) {
      return function (handle) {
          return function (a) {
              return function (b) {
                  return function (c) {
                      return new LoopBuf(Data_Maybe.Nothing.value, handle, ap_(a), b, c);
                  };
              };
          };
      };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.Scratch"] = $PS["FRP.Behavior.Audio.Example.Scratch"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.Scratch"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var scene = function (time) {
      ...
      return Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(FRP_Behavior_Audio["speaker'"](Data_Typelevel_Num_Sets.posD1)(FRP_Behavior_Audio["gain'"](Data_Typelevel_Num_Sets.posD1)(0.2)(FRP_Behavior_Audio.loopBuf(Data_Typelevel_Num_Sets.posD1)("scratch")(2.0 + $$Math.sin(rad))(0.0)(0.0))));
  };
  var main = function (ctx) {
      var buf = Control_Promise.toAffE(FRP_Behavior_Audio.decodeAudioDataFromUri(ctx)("https://freesound.org/data/previews/71/71853_1062668-lq.mp3"));
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(buf)(function (b) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Behavior_Audio.runInBrowser(FRP_Behavior_Audio.soundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD1))(scene)(Data_Unit.unit)(ctx)({
              msBetweenSamples: 20,
              msBetweenPings: 15,
              ...
              buffers: Foreign_Object.singleton("scratch")(b)
          })({
...
PS["FRP.Behavior.Audio.Example.Scratch"].main();