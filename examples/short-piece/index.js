...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FRP.Behavior.Audio.Example.Piece"] = $PS["FRP.Behavior.Audio.Example.Piece"] || {};
  var exports = $PS["FRP.Behavior.Audio.Example.Piece"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Parallel_Class = $PS["Control.Parallel.Class"];
  ...
  var mez = function (n) {
      return function (a) {
          var a_ = Data_Semigroup.append(Data_Semigroup.semigroupArray)(a)(Data_Array.drop(2)(a));
          return Data_Array.mapWithIndex(function (i) {
              return function (x) {
                  var moddy = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(i)(8);
                  return new PVD(x, Data_Int.toNumber(i + (n * 16 | 0) | 0), tempo * (3.0 + 0.5 * Data_Int.toNumber((function () {
                      var $8 = moddy < 3;
                      if ($8) {
                          return 8 - moddy | 0;
                      };
          ...
          })(Data_Semigroup.append(Data_Semigroup.semigroupArray)(a_)(a_));
      };
  };
  var kr = 20.0 / 1000.0;
              ...
              return function (dur) {
                  return function (doRelease) {
                      return Data_Semigroup.append(Data_List_Types.semigroupList)((function () {
                          var $9 = t + kr > s && t < s + dur + kr;
                          if ($9) {
                              return Control_Applicative.pure(Data_List_Types.applicativeList)(FRP_Behavior_Audio.playBufT_(Data_Typelevel_Num_Sets.posD2)(name + ("_" + Data_Show.show(Data_Show.showNumber)(s)))(name)({
                                  param: 1.0,
                          ...
                          var $10 = doRelease && (t >= s + dur + kr && t < s + dur + kr + 3.0);
                          if ($10) {
  ...
  var fin = 512.0;
  var piece = Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(0)([ 37, 41, 44, 49, 53 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(1)([ 37, 39, 46, 51, 54 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(2)([ 36, 39, 44, 51, 54 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(3)([ 37, 41, 44, 49, 53 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(4)([ 37, 41, 46, 53, 58 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(5)([ 37, 39, 43, 46, 51 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(6)([ 36, 39, 44, 51, 56 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(7)([ 36, 37, 41, 44, 49 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(8)([ 34, 37, 41, 44, 49 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(9)([ 27, 34, 39, 43, 49 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(10)([ 32, 36, 39, 44, 48 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(11)([ 32, 35, 41, 44, 50 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(12)([ 30, 34, 39, 46, 51 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(13)([ 30, 33, 39, 42, 48 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(14)([ 29, 32, 37, 44, 49 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(15)([ 29, 30, 34, 37, 42 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(16)([ 27, 30, 34, 37, 42 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(17)([ 20, 27, 32, 36, 42 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(18)([ 25, 29, 32, 37, 41 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(19)([ 25, 32, 35, 37, 41 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(20)([ 18, 30, 34, 37, 41 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(21)([ 19, 25, 34, 37, 40 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(22)([ 21, 30, 36, 37, 39 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(23)([ 20, 30, 32, 36, 39 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(24)([ 20, 29, 32, 37, 41 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(25)([ 20, 27, 32, 37, 42 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(26)([ 20, 27, 32, 36, 42 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(27)([ 20, 28, 34, 37, 43 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(28)([ 20, 29, 32, 37, 44 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(29)([ 20, 27, 32, 37, 42 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(30)([ 20, 27, 32, 36, 42 ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mez(31)([ 13, 25, 32, 35, 41 ]))(Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return new PVD(v.value0, v.value1 + fin, v.value2, v.value3);
  })((function (v) {
      return v.acc;
  })(Data_Foldable.foldl(Data_Foldable.foldableArray)(function (v) {
      return function (v1) {
          return {
              acc: Data_Semigroup.append(Data_Semigroup.semigroupArray)(v.acc)([ new PVD(v1.value0, v.prev, v1.value2, v1.value3) ]),
              prev: v1.value1 + v.prev
          };
      };
  })({
      acc: [  ],
      prev: 0.0
  })([ new PVD(13, 1.0, 1.5, true), new PVD(25, 1.0, 1.5, true), new PVD(30, 1.0, 1.5, true), new PVD(34, 1.0, 1.5, true), new PVD(37, 1.0, 1.5, true), new PVD(42, 1.0, 1.5, true), new PVD(37, 1.0, 1.5, true), new PVD(34, 1.0, 1.5, true), new PVD(37, 1.0, 1.5, true), new PVD(34, 1.0, 1.5, true), new PVD(30, 1.0, 1.5, true), new PVD(34, 1.0, 1.5, true), new PVD(30, 1.1, 1.5, true), new PVD(27, 1.1, 1.5, true), new PVD(30, 1.2, 1.5, true), new PVD(27, 1.6, 1.5, true), new PVD(13, 1.9, 6.0, true), new PVD(24, 1.65, 6.0, true), new PVD(44, 1.4, 6.0, false), new PVD(48, 1.25, 6.0, false), new PVD(51, 1.2, 6.0, true), new PVD(54, 1.1, 6.0, true), new PVD(51, 1.05, 6.0, true), new PVD(48, 1.0, 6.0, false), new PVD(51, 1.05, 6.0, false), new PVD(48, 1.1, 6.0, false), new PVD(44, 1.15, 6.0, false), new PVD(48, 1.2, 5.0, false), new PVD(39, 1.3, 4.0, false), new PVD(42, 1.7, 3.0, false), new PVD(41, 2.0, 3.0, false), new PVD(39, 6.0, 3.0, false), new PVD(13, 0.5, 6.0, false), new PVD(25, 0.2, 6.0, false), new PVD(41, 0.23, 6.0, false), new PVD(44, 0.2, 6.0, false), new PVD(49, 1.0, 6.0, false), new PVD(39, 1.0, 6.0, false), new PVD(41, 1.0, 6.0, false) ])))))))))))))))))))))))))))))))))));
  var dl = function (ctx) {
      return function (s) {
  ...
  var buffers = function (ctx) {
      return Control_Parallel_Class.sequential(Effect_Aff.parallelAff)(Data_Traversable.sequence(Foreign_Object.traversableObject)(Effect_Aff.applicativeParAff)(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dl(ctx)(""))(dl(ctx)("r")))));
  };
  var main = function (ctx) {
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(buffers(ctx))(function (bufs) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Behavior_Audio.runInBrowser_(FRP_Behavior_Audio.soundscapeRunnableMedia(Data_Typelevel_Num_Sets.posD2))(function __do() {
              ...
              var smaller = Data_Functor.map(Data_Functor.functorArray)(function (a) {
                  return new Data_Tuple.Tuple(Data_Tuple.fst(a) * 1.5e-2, Data_Tuple.snd(a) * 0.3);
              })(randy);
...
PS["FRP.Behavior.Audio.Example.Piece"].main();